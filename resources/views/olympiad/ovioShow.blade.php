...
@section('title', 'Олимпиады Наше наследие')

@section ('content')
		<div class='row singleOlympiad'>
			<div class='col-xl-2 col-lg-5 col-12' >
				<div class="pict"> <img class='logoOlympiad' src='/css/personal/pictCSS/ovio188.png'></div>
			</div>	
			<div class='col-xl-4 col-lg-7 col-12 '>	
				<div class="title"><h2>Наше наследие</h2></div>
			</div>	
...
<h2>Открытая всероссийская интеллектуальная олимпиада "Наше наследие"</h2>
