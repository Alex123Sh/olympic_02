...
@section ('content')
		...
		<div class='row singleOlympiad'>
			<div class='col-xl-2 col-lg-5 col-12' >
				<div class="pict"> <img class='logoOlympiad' src='/css/personal/pictCSS/opk188.png'></div>
			</div>	
			<div class='col-xl-4 col-lg-7 col-12 '>	
				<div class="title"><h2>Oсновы Православной Культуры</h2></div>
			</div>	
...
<h2>Олимпиады - Основы православной культуры</h2>		
<div class='row'>
